...
$(document).ready(function() {
    ...
    $(".plupload").length > 0 && $(".plupload").each(function() {
        ...
        e.pluploadQueue({
            ...
            url: "adminskin/js/plugins/plupload/upload.php",
            max_file_size: "10mb",
            chunk_size: "1mb",
            unique_names: !0,
            resize: {
            ...
            flash_swf_url: "adminskin/js/plugins/plupload/plupload.flash.swf",
            silverlight_xap_url: "adminskin/js/plupload/plupload.silverlight.xap"
        });
        ...
        if (!$(this).hasClass("dataTable-custom")) {
            var e = {
                ...
                oLanguage: {
                    ...
                    sInfo: "从 <span>_START_</span> 到 <span>_END_</span> 条数据 / 共 <span>_TOTAL_</span> 条数据",
                    sZeroRecords: "没有检索到数据",
                    sLengthMenu: "_MENU_ <span>条数据/每页</span>",
            ...
            if ($(this).hasClass("dataTable-tools")) {
                $(this).hasClass("dataTable-colvis") ? e.sDom = 'TC<"clear">lfrtip': e.sDom = 'T<"clear">lfrtip';
                e.oTableTools = {
                    sSwfPath: "adminskin/js/plugins/datatable/copy_csv_xls_pdf.swf",
            ...
            if ($(this).hasClass("dataTable-scroller")) {
                e.sScrollY = "300px";
                e.bDeferRender = !0;
                $(this).hasClass("dataTable-tools") ? e.sDom = 'T<"clear">frtiS': e.sDom = "frtiS";
                e.sAjaxSource = "adminskin/js/plugins/datatable/demo.txt"
            }
